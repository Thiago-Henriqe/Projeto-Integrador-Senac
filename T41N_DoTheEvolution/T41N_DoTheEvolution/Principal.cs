...
namespace T41N_DoTheEvolution
{
    public partial class Principal : Form
    {
        ...
        private void Principal_Load(object sender, EventArgs e)
        {
            ...
            acessar.Show();
            eNTRARToolStripMenuItem.Visible = false;
        ...
        {
            CORRIDASToolStripMenuItem.Visible = false;
            FUNCIONARIOSToolStripMenuItem.Visible = false;
            MOTOBOYSToolStripMenuItem.Visible = false;
            CLIENTESToolStripMenuItem.Visible = false;
            RELATORIOToolStripMenuItem.Visible = false;
            deslogarToolStripMenuItem.Visible = false;
            eNTRARToolStripMenuItem.Visible = true;
        }
